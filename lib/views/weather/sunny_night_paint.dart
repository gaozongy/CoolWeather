...
class SunnyNightPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawColor(Color(0xFF061324), BlendMode.color);
    ...
    canvas.drawArc(
        Rect.fromCircle(center: offset, radius: 685), 3.2, 4.2, false, paint_12);

    canvas.drawArc(
        Rect.fromCircle(center: offset, radius: 715), 1.2, 5.2, false, paint_13);

    canvas.drawArc(
        Rect.fromCircle(center: offset, radius: 740), 3.2, 5.5, false, paint_14);
